...
public static class EmployeeErrors
{
    ...
    public static Error FirstNameRequired =>
        Error.Validation("Employee.FirstName.Required", "First name is required and cannot be empty or whitespace.");

    public static Error LastNameRequired =>
        Error.Validation("Employee.LastName.Required", "Last name is required and cannot be empty or whitespace.");
